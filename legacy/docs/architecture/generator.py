...
if __name__ == "__main__":
    ...
    input_md = os.path.join(current_dir, "MASTER_SYSTEM_BLUEPRINT.md")
    output_pdf = os.path.join(current_dir, "SYSTEM_BLUEPRINT.pdf")
